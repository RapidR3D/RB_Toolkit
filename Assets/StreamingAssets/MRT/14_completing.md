# <color=#FFD700>Completing Work Orders</color>  
...
## <color=#FF8C00>Completion Checklist</color>  

### <color=#20B2AA>Before Logging Out</color>  
...
## <color=#FF8C00>Reporting Set Out at Destination</color>  

### <color=#20B2AA>Final Station Work</color>  

When you arrive at your destination yard:  

#### Step 1: Handle Inbound AEI Read
<color=#FF8C00>**Before reporting set out:**</color>  
...
<color=#FF8C00>**Function Buttons:**</color>  
...
## <color=#FF8C00>Multiple Cuts in Destination</color>  

### <color=#20B2AA>When Setting Out to Multiple Tracks</color>  
...
### <color=#20B2AA>⚠️ Critical Time Rule for Set Outs</color>  
<color=#FF8C00>**Set Outs need at least 1 minute apart per cut!**</color>  
<color=#FF8C00>**Example:**</color>  
Cut 1 to W23: 17:00  
Cut 2 to W25: 17:01  
Cut 3 to W27: 17:02  

<color=#FF8C00>**Why:**</color> System tracks each cut as separate movement for inventory management.  

---

## <color=#FF8C00>Reporting Locomotives</color>  

### <color=#20B2AA>After All Cars Are Set Out</color>  
...
## <color=#FF8C00>Final Verification</color>  

### <color=#20B2AA>Swipe to Check All Tiles</color>  
...
## <color=#FF8C00>Logging Out of Work Order</color>  

### <color=#20B2AA>⚠️ CRITICAL STEP</color>  
<color=#FF8C00>**You MUST logout to post data down to the system!**</color>  
### <color=#20B2AA>Logout Process</color>  
...
Login with Okta  
[Button]  
<color=#FF8C00>**When you see this screen, logout was successful!**</color>  
---

## <color=#FF8C00>What Happens When You Logout</color>  

### <color=#20B2AA>Data Posting</color>  
...
### <color=#20B2AA>If You DON'T Logout</color>  
❌ <color=#FF8C00>**Problems that occur:**</color>  
...
### <color=#20B2AA>If MQTT Shows "No"</color>  
<color=#FF8C00>**Problem:**</color> Data may not be syncing properly  
...
## <color=#FF8C00>Recrewing Procedures</color>  

### <color=#20B2AA>When Your Train Will Be Recrewed</color>  
...
### <color=#20B2AA>⚠️ Critical for Recrewing</color>  
...
## <color=#FF8C00>End of Shift Procedures</color>  

### <color=#20B2AA>After Logging Out of MRT</color>  
...
<color=#FF8C00>**Do NOT power down - RESTART instead!**</color>  
<color=#FF8C00>**How to Restart:**</color>  
1. Hold power button  
2. Tap **Restart**  
3. Confirm by tapping **Restart** again  
4. Wait for tablet to fully restart  

<color=#FF8C00>**Why Restart (not power down):**</color>  
...
## <color=#FF8C00>Completion Verification</color>  

### <color=#20B2AA>How to Verify Work Posted</color>  
...
## <color=#FF8C00>Common Completion Errors</color>  

### <color=#20B2AA>Error 1: Forgot to Logout</color>  
<color=#FF8C00>**Problem:**</color> Work order still open in system  
...
### <color=#20B2AA>Error 2: MQTT Not Connected</color>  
<color=#FF8C00>**Problem:**</color> Data didn't sync before logout  
...
### <color=#20B2AA>Error 3: Tiles Not 100% Complete</color>  
<color=#FF8C00>**Problem:**</color> Logged out with incomplete work  
...
### <color=#20B2AA>Error 4: Locomotives Not Reported</color>  
<color=#FF8C00>**Problem:**</color> Most common completion error!  
...
## <color=#FF8C00>Troubleshooting Completion Issues</color>  

### <color=#20B2AA>Cannot Logout - Button Greyed Out</color>  
<color=#FF8C00>**Cause:**</color> Work order not complete or system processing  

<color=#FF8C00>**Fix:**</color>  
...
### <color=#20B2AA>"Pending Data" Message</color>  
<color=#FF8C00>**Cause:**</color> System still syncing previous events  
...
### <color=#20B2AA>Logged Out But Work Order Still Appears</color>  
<color=#FF8C00>**Cause:**</color> Data didn't post properly  
...
## <color=#FF8C00>Best Practices for Completion</color>  

### <color=#20B2AA>During Your Shift</color>  
...
### <color=#20B2AA>At Destination</color>  
...
### <color=#20B2AA>Before Logout</color>  
...
### <color=#20B2AA>After Logout</color>  
...
## <color=#FF8C00>Completion Success Indicators</color>  

### <color=#20B2AA>✅ You're Done When...</color>  
...
### <color=#20B2AA>❌ You're NOT Done If...</color>  
...
## <color=#FF8C00>Summary: The Perfect Completion</color>  
